...
class TestStm32(unittest.TestCase):
    def setUp(self):
        ...
        # self._driver = stlib.stm32.Stm32(stlink=None, dbg=dbg)
    ...
    def test_find_mcus_by_core_fail(self):
        ...
        class MockStlink():
            def get_debugreg32(self, reg):
                ...
                return 0x410fc251
        self._pystlink._stlink = MockStlink()
        with self.assertRaises(stlib.stlinkex.StlinkException):
            self._pystlink.find_mcus_by_core()
...
class TestStm32_get_mem(unittest.TestCase):
    def setUp(self):
        ...
        self._driver = stlib.stm32.Stm32(stlink=MockStlink(self), dbg=MockDbg())
